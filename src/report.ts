...
import type { Analysis, VariantSummary } from "./analyze.js";
import { REPORT_PATH } from "./constants.js";
...
<p class="muted">Static token cost of each section (~${totalInstructionTokens.toLocaleString()} tokens total, paid on every run). The benefit side is measured above at the whole-file level; per-section impact needs <code>--ablate</code> (coming soon).</p>
<table>
